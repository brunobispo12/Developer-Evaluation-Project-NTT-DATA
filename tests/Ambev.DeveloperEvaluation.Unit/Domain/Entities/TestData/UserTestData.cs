...
namespace Ambev.DeveloperEvaluation.Unit.Domain.Entities.TestData
{
    ...
    public static class UserTestData
    {
        ...
        /// - Address (with valid City, Street, Number, Zipcode, and Geolocation)
        /// </summary>
        ...
        /// <summary>
        /// Generates a valid username-like string.
        /// Since the property "Username" no longer exists, this method returns a generated string
        /// combining a first name and a random number, simulating a username.
        /// </summary>
        /// <returns>A valid username-like string.</returns>
        public static string GenerateValidUsername()
        {
            var faker = new Faker();
            return $"{faker.Name.FirstName()}{faker.Random.Number(10, 99)}";
        }
        ...
        {
            // Return a string shorter than 8 characters to trigger the MinimumLength rule.
            return "short";
        }
        ...
        /// <summary>
        /// Generates a username-like string that exceeds the maximum length limit.
        ...
        /// </summary>
        /// <returns>A username-like string that exceeds the maximum length limit.</returns>
